...
| M23 | Audio subsystem (AC97 / HDA / I2S)              | Devices          | ◐ stage 1 (DOCS §4.26) + stage 2 WAV player, blocking playback, honest frame counts (DOCS §4.26.1).  **All 3 arches** (virtio-sound on ARM).  + stage 3 `/dev/dsp` (DOCS §4.26.1).  Open: mixer, input, HDA, AC97 IRQ |
