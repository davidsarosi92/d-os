...
void kernel_main(uint32_t mb_magic, uintptr_t mb_info) {
     ...
     * userland (/lib ld.so + .so's) the interactive shell may need. */
    {
        ...
        extern const unsigned char _binary_user_pngtest_dynelf_start[]       __attribute__((weak));
        extern const unsigned char _binary_user_pngtest_dynelf_end[]         __attribute__((weak));
        extern const unsigned char _binary_user_fttest_dynelf_start[]        __attribute__((weak));
        extern const unsigned char _binary_user_fttest_dynelf_end[]          __attribute__((weak));
        extern const unsigned char _binary_user_hbtest_dynelf_start[]        __attribute__((weak));
        ...
        extern const unsigned char _binary_user_hbbtest_dynelf_start[]       __attribute__((weak));
        extern const unsigned char _binary_user_hbbtest_dynelf_end[]         __attribute__((weak));
        extern const unsigned char _binary_user_gtest_dynelf_start[]         __attribute__((weak));
        ...
        struct { const char* name; const unsigned char* s; const unsigned char* e; } tests[] = {
            ...
            { "pngtest (libpng)",   _binary_user_pngtest_dynelf_start,      _binary_user_pngtest_dynelf_end      },
